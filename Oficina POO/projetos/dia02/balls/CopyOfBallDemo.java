...
/**
 * Class CopyOfBallDemo - provides two short demonstrations showing how to use the 
 * Canvas class. 
 *
...
public class CopyOfBallDemo   
{
    ...
    public static void main(String[] args) {
        CopyOfBallDemo demo = new CopyOfBallDemo();
        demo.bounce();
    }
