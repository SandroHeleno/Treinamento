...
public class AddressBookFileHandler
{
     ...
     */
    public AddressBookFileHandler(AddressBookDemo demo)
    {
        this.book = demo.getBook();
    }
     ...
     * problems are reported directly by this method.
     */
    public void showSerializationFile(String sourceFile)
        throws IOException, ClassNotFoundException
    {
        AddressBook book = null;
        try {
            book = readFromFile(sourceFile);
